...
<html lang="en">
    ...
    <body class="bg-gradient-primary">
        <nav class="navbar navbar-expand-lg navbar-dark bg-white shadow-lg pb-3 pt-3 font-weight-bold">
            <div class="container">
                <a class="navbar-brand text-primary" style="font-weight: 900;" href="<?= base_url('')?>"> <i class="fa fa-database mr-2 rotate-n-15"></i> Sistem Pendukung Keputusan Metode MAUT</a>
            </div>
        </nav>
                                ...
                                <div class="col-lg-12">
                                    <div class="p-5">
                                        <div class="text-center">
                                            ...
                                            <img src="assets/img/polinema_logo.png" alt="" width="60%" style="margin-bottom: 15px;">
                                        </div>
