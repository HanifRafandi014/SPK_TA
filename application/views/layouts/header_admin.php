...
<head>
  ...
  <title>Polinema - Multi-Attribute Utility Theory</title>
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= base_url('Login/home'); ?>">
        <div class="sidebar-brand-icon">
          <img src="<?= base_url('assets/img/polinema_logo.png'); ?>" alt="Logo" style="width: 50px; height: 50px;">
        </div>
        <div class="sidebar-brand-text mx-3">Politeknik Negeri Malang</div>
      </a>
